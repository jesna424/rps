...
scissor_img = ImageTk.PhotoImage(Image.open("sc-user.png "))
rock_img_comp = ImageTk.PhotoImage(Image.open("rock.png "))
paper_img_comp = ImageTk.PhotoImage(Image.open("paper.png "))
scissor_img_comp = ImageTk.PhotoImage(Image.open("sc.png "))
...
rock = Button(root,width=20,height=2,text="ROCK",
                bg="dimgrey",fg="white",command = lambda:updateChoice("rock")).grid(row=2,column=1)
paper = Button(root,width=20,height=2,text="PAPER",
                bg="silver",fg="white",command = lambda:updateChoice("paper")).grid(row=2,column=2)
scissor = Button(root,width=20,height=2,text="SCISSOR",
                bg="dimgrey",fg="white",command = lambda:updateChoice("scissor")).grid(row=2,column=3)
